...
void findLocations(const string& tweet, vector<pair<double, double>>& coordinateList) { //O(c) or O(c + v) if resize where c is the number of characters in a tweet and v is the number of coordinates
    ...
    ifstream file("/home/o8cu6ib1kcn3/public_html/public/integrate/c++/cities1000.txt"); //O(1)
...
vector<string> getData() {
    ...
    //Open the file
    ifstream data("/home/o8cu6ib1kcn3/public_html/public/integrate/c++/data.txt");
...
string randomProfile() {
    string source = "/home/o8cu6ib1kcn3/virtualenv/pythonApp/3.7/bin/python3.7_bin /home/o8cu6ib1kcn3/public_html/public/integrate/c++/Finder.py";
